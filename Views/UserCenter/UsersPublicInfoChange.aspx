<%@ Page Title="" Language="C#" MasterPageFile="~/Resource/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="UsersPublicInfoChange.aspx.cs" Inherits="Views_UserCenter_UsersPublicInfoChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server" ClientIDMode="Static">
    ...
    <input id="txtUIDS" type="hidden" runat="server" />
    <input id="txtType" type="hidden" runat="server" />
    <script src="<%=ResolveUrl("~/Views/UserCenter/Js/UsersPublicInfoChange.js")%>"></script>
</asp:Content>
