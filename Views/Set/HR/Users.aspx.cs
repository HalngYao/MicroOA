...
public partial class Views_Set_HR_Users : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!MicroAuth.CheckPermit(ModuleID, "11"))
        {
            ...
            link1ChangeWorkHourSystem.Attributes.Add("class", "");
            link1ChangeWorkHourSystem.Attributes.Remove("lay-event");

            link2ChangeWorkHourSystem.Attributes.Add("class", "");
            link2ChangeWorkHourSystem.Attributes.Remove("lay-event");

        }
        else
            txtEditCell.Value = "True";
    }
