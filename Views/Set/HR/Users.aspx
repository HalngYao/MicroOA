<%@ Page Title="" Language="C#" MasterPageFile="~/Resource/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="Users.aspx.cs" Inherits="Views_Set_HR_Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" ClientIDMode="Static">
    ...
    <input name="txtEditCell" type="hidden" id="txtEditCell" runat="server" value=""/>
    ...
    <script src="<%: ResolveUrl("~/Views/Set/Js/Users.js")%>"></script>
</asp:Content>
