...
public partial class Views_Tools_CodeTools : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!MicroAuth.CheckPermit(ModuleID, "2"))
        {
            ...
            btnInsert.Attributes.Add("class", "layui-btn layui-btn-disabled");

            btnUpdate.Disabled = true;
            btnUpdate.Attributes.Add("class", "layui-btn layui-btn-disabled");

            btnField.Disabled = true;
            btnField.Attributes.Add("class", "layui-btn layui-btn-disabled");
        }
